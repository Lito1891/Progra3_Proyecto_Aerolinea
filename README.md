...
Cada colaborador debe crear su propia rama para trabajar: bash git checkout -b nombre-rama
📝 Buenas prácticas- Usar mensajes de commit claros y descriptivos.
